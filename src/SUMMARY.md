...
- [A New Era](./00.a.new.era.md)
- [The Developer](./01.the.developer.md)
- [The Anomaly](./02.the.anomaly.md)
- [Debugging](./03.debugging.md)
- [The Incident](./04.the.incident.md)
- [A Risky Call](./05.a.risky.call.md)
- [Connecting the Dots](./06.connecting.the.dots.md)
