...
Andrew easily provided the answers, saying, "The Order, as far as I know, comprises all our Elders. As I mentioned before, they believe in the possibility of a war against AI and are preparing for it. They've constructed 25 vaults worldwide, with each vault designed to accommodate 10 000 people. Of course, these spaces are reserved for active members and sponsors of the AI Church."
...
Wednesday. Dan takes the day off. The chief allows it.

Access to the laptop.

The browser was open. In one of the pinned tabs, Dan saw the Gmail page with a personal mailbox open. Dan found the draft of the letter that Andrew wanted to send to him.

Andrew found additional information that he didn't share with Dan but wrote in the letter.

"If you received this message, then I lost this battle. But I hope you will win the war.

My story started four years ago when I met William Thompson. He helped me, and I joined the AI Church with pleasure.

I worked for this organization all this time. We have many interesting projects that should help humanity.

The Order of the Resistance is an organization within the AI Church.
...
And they sold this idea around the world. For a high price.

advertising brochure with the price list for a vault, 10 BTC for the very basic level, every vault also has apartments for 100 BTC and 10 places for 1,000 BTC.
every Vault has a personal balance, personal wallet, list of all 25 BTC wallets is here
every Elder responsible for one vault for one wallet
I only know one wallet of William Thompson
list of all Elders
...
And to achieve this goal, they are ready to do anything.

Story about the homeless, about Ifrit, and the security department.

list of all guys from the security department
You can find documents; they are attached to this letter."

But the documents weren't attached. Dan spent several minutes before finding documents in the folder "porno" on the desktop.

"Foolish jokes, as always, Andrew," thought Dan.

Dan added more information that he already knows.

Information manipulation.
AI Church "bots" and their profiles. BTC wallets that he can identify.
Dropship sites.
Link between Dark Alert and William Thompson.
Dan removed his email from recipients and added addresses to several famous newspapers around the world. Dan scheduled sending the letter from Andrew to be sent in the future. It will be sent in one week, on his birthday; he would be 23 years old.

Dan removed all information about Andrew's investigation from the laptop and signed out from his Gmail account on all devices and, in the end, on this laptop.

On Friday, security from AI church comes to the office and grabs all of Andrew's stuff, and the laptop too.

All that was left was to wait.

# 23. Result of the letter's publication

The letter was like a big bomb.

The activity of the AI Church was frozen, and some individuals were arrested. The Interpol, FBI and CIA joined the investigation. Many of the Elders were arrested, and they also received charges of tax evasion on an especially large scale. But not Ifrit and his mercenaries; they disappeared without a trace.
...
The AI Church bots network, because Dan added information about their wallets and of course, none of them paid taxes on this activity, and as a result, many of them were arrested too.

"Anonymity on the Internet is just an illusion."

The public investigation into 25 Church's BTC wallets had a very high impact. All incoming payments, of course, were anonymous. All of them were from a BTC mixer, but for the sake of economy, AI Church created a dedicated mixer; they didn't want to pay fees for mixing. As a result, all BTC transactions that came to the AI church wallet were just mixed with other BTC transactions to the AI church. So, the Reddit community was easily able to recognize over 50 thousand wallets. Somebody created a site with a UI to easily search the database for these wallets and added the possibility to leave comments for every transaction of these wallets. It started as an attempt to de-anonymize, but in fact, many comments were about the fact of corruption. Interpol joined this investigation, and other policies in different countries. It was a tsunami of criminal cases of corruption around the world.

Against this background, the Bitcoin rate fell to its lowest level in 3 years.

Despite these events, the AI Church followers continued to exist but with far fewer investments. They shifted their focus from promoting "AI as our God" to "AI as our enemy," and now they really look more like fanatics, not the smart guys they were before.

In the AI community, a new main direction was born: to establish a set of rules for AI, including in the military sector. They advocated for a new doctrine suitable for modern times.

The main part of Elders was arrested, and police received access to their BTC wallets all BTC was frozen. But several wallets with big amount of BTC are still active, because fourth Elders fled from justice. And they continue to control these wallets.
But it looks like cursed treasure, because many they were monitored by many law enforcement agencies. And Dan.

# 24

Dan and Lilla sit in a café.

The Budapest Post was also in the list of recipients, and Lilla's article was again on the first page, once more about AI. Lilla had too many questions, but Dan didn't want to provide answers.

Dan looked at his phone and swiped through photos from school. They were what he had taken from Kharkiv, his memories from another life.

"My father told me that he never removes contacts of people who died. They are memories, and he never deletes contacts from his phone book. And now I understand him."

Lilla listened to Dan; she understood that he didn't need a dialogue; he needed someone close to him now.

"Press F to pay respects," Dan whispered and put the phone aside.
